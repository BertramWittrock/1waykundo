...
const MatrixWindow = ({ title, onClose, children, zIndex, onBringToFront, instanceKey }) => {
  ...
  return (
    ...
    >
      <div 
        ref={nodeRef}
        className={`
          absolute w-[90vw] sm:w-[500px] max-w-[500px] bg-black border border-[#00ff00]/70
      ...
      >
        ...
        {/* Window Content */}
        <div className="text-[#00ff00] text-sm sm:text-base [&>*]:leading-tight space-y-[2px] max-h-[60vh] overflow-auto custom-scrollbar">
          {children}
        </div>
